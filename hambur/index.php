<?php   
    ...
    // Incluir config file comando de php que permite incluir archivos
...
<body>
    ...
    <div class="lista-platillos" class="container">
        ...
        <?php
            ...
            $countregistros = 0; //poder ordenar 1,2,3
            $sql="select * from productos where pro_activa = 1";//busca productos que esten activos
            $resultado=mysqli_query($link,$sql);//ejecuta con la db
            //se guarda el resultado de la consulta
            while($result=mysqli_fetch_array($resultado))//repite
        ...
        <?php 
            ...
            $countregistros=0;} //permite la cantidad de productos que se quieren ver
            }
        ?>
